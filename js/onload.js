window.onload = function() {
    ...
    if (document.getElementById('footer')) {
        document.getElementById('footer').innerHTML =`
                <div class="container-imagem-about-us">
                    <img src="assets/about.jpg" alt="Pessoas trabalhando" class="imagem-abus img-fluid">
                    <img src="assets/quadrado-animacao.png" alt="quadrado animado" class="quadrado img-fluid">
                </div>
                <div class="texto-about-us pe-3">
                    <p id="title"><b>About Us</b></p>
                    <hr>
                    <br>
                    <h2>Empowering Your Business with Innovative <strong class="destaque-texto-technology">Technology Solutions</strong></h2>
                    ...
                    <button id="btn-banner" type="button" class="btn btn-lg">More Details &rarr;</button>
                </div>
        `;
    };
};